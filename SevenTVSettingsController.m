...
#define S7TVBoolLC(k) [[NSUserDefaults standardUserDefaults] boolForKey:k]
#define S7TVSetBoolLC(k,v) do { [[NSUserDefaults standardUserDefaults] setBool:v forKey:k]; [[NSUserDefaults standardUserDefaults] synchronize]; } while(0)
...
- (void)toggleAutoCollect:(UISwitch *)sw { S7TVSetBoolLC(kTCLiveAutoCollectChannelPoints, sw.isOn); }
